...
export const en: Dictionary = {
  ...
  planner: {
    ...
    walkToDestination: 'Walk to {place}',
    walkFromOrigin: 'Walk from {place}',
    walkWholeWay: 'Walk from {from} to {to}',
    ...
    totalWalking: 'Walking {duration} · {distance}',
    totalWaiting: 'Waiting {duration}',
    totalRiding: 'Riding {duration}',
    ridingDistance: 'On board {distance}',
