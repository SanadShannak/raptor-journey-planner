...
export const ar: Dictionary = {
  ...
  planner: {
    ...
    speedSlow: 'بطيئة · 2.5 كم/س',
    speedCalm: 'هادئة · 3.5 كم/س',
    speedAverage: 'متوسطة · 4.6 كم/س',
    speedFast: 'سريعة · 6 كم/س',
    submit: 'ابحث عن رحلة',
    ...
    earlier: 'أبكر',
    later: 'أحدث',
    noEarlier: 'لم يُعثر على رحلة أبكر.',
    noLater: 'لم يُعثر على رحلة أحدث.',
    walkLeg: 'امشِ إلى {place}',
    walkToDestination: 'امشِ إلى وجهتك',
