...
export const ar: Dictionary = {
  ...
  planner: {
    ...
    walkLeg: 'امشِ إلى {place}',
    walkToDestination: 'امشِ إلى {place}',
    walkFromOrigin: 'امشِ من {place}',
    walkWholeWay: 'امشِ من {from} إلى {to}',
    ...
    ridingDistance: 'على متن المركبة {distance}',
